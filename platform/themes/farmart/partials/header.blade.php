...
<head>
    ...
    <style>
        :root {
            ...
            --primary-color-rgb: {
                    {
                    implode(', ', BaseHelper::hexToRgb(theme_option('primary_color', '#fab528')))
                }
            }
            ...
            --primary-button-background-color: {
                    {
                    theme_option('primary_button_background_color') ?: theme_option('primary_color', '#fab528')
                }
            }
            ...
            --top-header-text-color: {
                    {
                    theme_option('top_header_text_color') ?: theme_option('header_text_color', '#000')
                }
            }
            ...
            --middle-header-text-color: {
                    {
                    theme_option('middle_header_text_color') ?: theme_option('header_text_color', '#000')
                }
            }
            ...
            --bottom-header-text-color: {
                    {
                    theme_option('bottom_header_text_color') ?: theme_option('header_text_color', '#000')
                }
            }
            ...
            --header-mobile-background-color: {
                    {
                    theme_option('header_mobile_background_color', '#fff')
                }
            }
            ...
            --header-mobile-icon-color: {
                    {
                    theme_option('header_mobile_icon_color', '#222')
                }
            }
            ...
            --footer-hover-color: {
                    {
                    theme_option('footer_hover_color', '#fab528')
                }
            }
...
<body {!! Theme::bodyAttributes() !!}>
    ...
    <header class="header header-js-handler" data-sticky="{{ theme_option('sticky_header_enabled', 'yes') == 'yes' ? 'true' : 'false' }}">
        <div @class([ 'header-top d-none d-lg-block' , 'header-content-sticky'=>
                            ...
                            <div class="header-info header-info-right">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span class="d-inline-block ms-1">(<a class="color-primary" href="{{ route('customer.logout') }}">{{ __('Logout') }}</a>)</span>
                                    </li>
                                    @else
        ...
        <div @class([ 'header-bottom' , 'header-content-sticky'=>
                    ...
                    <div class="container-xxxl">
                        <div class="navigation__left">
                            ...
                            <div class="menu--product-categories">
                                ...
                                <div class="menu__content" data-bb-toggle="init-categories-dropdown" data-bb-target=".menu--dropdown" data-url="{{ route('public.ajax.categories-dropdown') }}">
