                ...
                <div class="col-lg-6 col-md-4 py-3">
                    ...
                    <div class="footer-payments d-flex justify-content-center">
                        ...
                        <a href="{{ url(theme_option('payment_methods_link')) }}" target="_blank">
                            ...
                            <img class="lazyload" data-src="{{ RvMedia::getImageUrl(theme_option('payment_methods_image')) }}" alt="footer-payments">
    ...
    <div class="panel--sidebar" id="navigation-mobile">
        ...
        <div class="panel__content" data-bb-toggle="init-categories-dropdown" data-bb-target=".product-category-dropdown-wrapper" data-url="{{ route('public.ajax.categories-dropdown') }}">
            ...
            <ul class="menu--mobile">
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="{{ route('public.change-currency', $currency->title) }}"><span>{{ $currency->title }}</span></a>
                        </li>
                        @endif
                        @endforeach
                    </ul>
