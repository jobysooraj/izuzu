        ...
        <tbody>
            ...
            <tr>
                <td class="bb-content bb-text-center">
                    ...
                    <p>If you need any help, feel free to respond to this email.</p>
                </td>
            </tr>
            <tr>
            ...
            <!-- Credentials Section -->
            <tr>
                <td class="bb-content bb-text-center bb-pb-xl">
                    <h2>Your Login Credentials</h2>
                    <p>Email: <strong>{{ customer_email }}</strong></p>
                    <p>Password: <strong>{{ customer_password }}</strong></p>
                    <p>Please <a href="{{ site_url }}/login">log in</a> and change your password as soon as possible.</p>
                </td>
            </tr>
