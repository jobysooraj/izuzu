...
<div class="core-menu-structure">
    ...
    <div class="row row-cards">
        <div class="col-md-4">
            ...
            <x-core::card>
                <x-core::card.header>
                    <a class="d-flex justify-content-between w-100 align-items-center text-decoration-none" data-bs-toggle="collapse" data-parent="#accordion" href="#collapseCustomLink">
                        <x-core::card.title>
                ...
                <div id="collapseCustomLink" class="box-links-for-menu collapse">
                    ...
                    <x-core::card.footer class="text-end">
                        <x-core::button type="button" class="btn-add-to-menu" :data-url="route('menus.get-node')" icon="ti ti-plus">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div @class(['mb-3'=> ! $loop->last])>
                                <x-core::form.checkbox :label="$description" id="menu_location_{{ $location }}" name="locations[]" :checked="in_array($location, $locations)" :value="$location" />
                            </div>
                            @endforeach
                        </div>
                    </div>
